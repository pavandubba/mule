...
public class ExtensionsNamespaceHandler extends NamespaceHandlerSupport
{
    ...
    private void xx(final Extension extension, final DataType parameterType, final ParserFactory factory)
    {
        parameterType.getQualifier().accept(new BaseDataQualifierVisitor()
        {
            ...
            public void onPojo()
            {
                String name = hyphenize(parameterType.getRawType().getSimpleName());
            ...
            public void onList()
            {
                ...
                {
                    xx(extension, parameterType.getGenericTypes()[0], factory);
                }
            }
            ...
            public void onMap()
            {
                ...
                if (genericTypes.length >= 2)
                {
                    ...
                    xx(extension, valueType, factory);
                }
            }
        });
    ...
    private void registerTopLevelParameter(Extension extension, Collection<Parameter> parameters, ParserFactory factory)
    {
        ...
        {
            xx(extension, parameter.getType(), factory);
        }
    }
